# Função onde o utilizador responde ao(s) questionario(s).
...
# Função para "Imprimir" as respostas que o utilizador respondeu ao(s) questionario(s).
